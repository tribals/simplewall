...
)
{
	...
	if (is_shortened || _r_config_getboolean_ex (L"ShowFilenames", TRUE, NULL))
	{
...
)
{
	...
	is_iconshidded = _r_config_getboolean_ex (L"IsIconsHidden", FALSE, NULL);
...
VOID _app_fileloggingenable ()
{
	...
	is_enable = _r_config_getboolean_ex (L"IsEnableAppMonitor", FALSE, NULL);
...
)
{
	...
	if (_r_config_getboolean_ex (L"IsNetworkResolutionsEnabled", FALSE, NULL))
	{
...
)
{
	...
	is_resolutionenabled = _r_config_getboolean_ex (L"IsNetworkResolutionsEnabled", FALSE, NULL);

...
)
{
	...
	if (_r_config_getboolean_ex (L"WF_State", TRUE, NULL))
	...
	if (SUCCEEDED (status))
	{
		_r_config_setboolean_ex (L"WF_State", is_flagchecked ? TRUE : FALSE, NULL);
...
)
{
	...
	switch (ctrl_id)
	{
		...
		{
			new_val = !_r_config_getboolean_ex (L"IsStartMinimized", FALSE, NULL);
			break;
		}
		...
		{
			new_val = !_r_config_getboolean_ex (L"BlockOutboundConnections", TRUE, NULL);
			break;
		}
		...
		{
			new_val = !_r_config_getboolean_ex (L"BlockInboundConnections", TRUE, NULL);
			break;
		}
		...
		{
			new_val = !_r_config_getboolean_ex (L"AllowLoopbackConnections", TRUE, NULL);
			break;
		}
		...
		{
			new_val = !_r_config_getboolean_ex (L"AllowIPv6", TRUE, NULL);
			break;
		}
		...
		{
			new_val = !_r_config_getboolean_ex (L"UseStealthMode", TRUE, NULL);
			break;
		}
		...
		{
			new_val = !_r_config_getboolean_ex (L"IsCertificatesEnabled", TRUE, NULL);
			break;
		}

		case IDM_KEEPUNUSED_CHK:
		{
			new_val = !_r_config_getboolean_ex (L"IsKeepUnusedApps", TRUE, NULL);
			break;
		}
		...
		{
			new_val = !_r_config_getboolean_ex (L"IsHashesEnabled", FALSE, NULL);
			break;
		}

		case IDC_INSTALLBOOTTIMEFILTERS_CHK:
		{
			new_val = !_r_config_getboolean_ex (L"InstallBoottimeFilters", TRUE, NULL);
			break;
		}
		...
		{
			new_val = !_r_config_getboolean_ex (L"IsNetworkResolutionsEnabled", FALSE, NULL);
			break;
		}

		case IDM_USEAPPMONITOR_CHK:
		{
			new_val = !_r_config_getboolean_ex (L"IsEnableAppMonitor", FALSE, NULL);
			break;
		}
	...
	switch (ctrl_id)
	{
		...
		case IDM_STARTMINIMIZED_CHK:
		{
			_r_config_setboolean_ex (L"IsStartMinimized", new_val, NULL);
		...
		case IDM_RULE_BLOCKOUTBOUND:
		{
			_r_config_setboolean_ex (L"BlockOutboundConnections", new_val, NULL);
		...
		case IDM_RULE_BLOCKINBOUND:
		{
			_r_config_setboolean_ex (L"BlockInboundConnections", new_val, NULL);
		...
		case IDM_RULE_ALLOWLOOPBACK:
		{
			_r_config_setboolean_ex (L"AllowLoopbackConnections", new_val, NULL);
		...
		case IDM_RULE_ALLOW6TO4:
		{
			_r_config_setboolean_ex (L"AllowIPv6", new_val, NULL);
		...
		case IDM_RULE_ALLOWWINDOWSUPDATE:
		{
			_r_config_setboolean_ex (L"IsWUFixEnabled", new_val, NULL);
		...
		case IDM_PROFILETYPE_PLAIN:
		{
			_r_config_setlong_ex (L"ProfileType", 0, NULL);
		...
		case IDM_PROFILETYPE_COMPRESSED:
		{
			_r_config_setlong_ex (L"ProfileType", 1, NULL);
		...
		case IDM_PROFILETYPE_ENCRYPTED:
		{
			_r_config_setlong_ex (L"ProfileType", 2, NULL);
		...
		case IDC_USESTEALTHMODE_CHK:
		{
			_r_config_setboolean_ex (L"UseStealthMode", new_val, NULL);
			break;
		}

		case IDC_INSTALLBOOTTIMEFILTERS_CHK:
		{
			_r_config_setboolean_ex (L"InstallBoottimeFilters", new_val, NULL);
			break;
		}
		...
		case IDM_USECERTIFICATES_CHK:
		{
			...
			_r_config_setboolean_ex (L"IsCertificatesEnabled", new_val, NULL);
		...
		case IDM_KEEPUNUSED_CHK:
		{
			_r_config_setboolean_ex (L"IsKeepUnusedApps", new_val, NULL);
		...
		case IDM_USEHASHES_CHK:
		{
			...
			_r_config_setboolean_ex (L"IsHashesEnabled", new_val, NULL);
		...
		case IDM_USENETWORKRESOLUTION_CHK:
		{
			_r_config_setboolean_ex (L"IsNetworkResolutionsEnabled", new_val, NULL);
		...
		case IDM_USEAPPMONITOR_CHK:
		{
			_r_config_setboolean_ex (L"IsEnableAppMonitor", new_val, NULL);
	...
	switch (msg)
	{
		case RM_INITIALIZE:
		{
			...
			switch (dialog_id)
			{
				...
				case IDD_SETTINGS_RULES:
				{
					...
					_r_ctrl_checkbutton (hwnd, IDC_RULE_BLOCKOUTBOUND, _r_config_getboolean_ex (L"BlockOutboundConnections", TRUE, NULL));
					_r_ctrl_checkbutton (hwnd, IDC_RULE_BLOCKINBOUND, _r_config_getboolean_ex (L"BlockInboundConnections", TRUE, NULL));
					_r_ctrl_checkbutton (hwnd, IDC_RULE_ALLOWLOOPBACK, _r_config_getboolean_ex (L"AllowLoopbackConnections", TRUE, NULL));
					_r_ctrl_checkbutton (hwnd, IDC_RULE_ALLOW6TO4, _r_config_getboolean_ex (L"AllowIPv6", TRUE, NULL));
					_r_ctrl_checkbutton (hwnd, IDC_USESTEALTHMODE_CHK, _r_config_getboolean_ex (L"UseStealthMode", TRUE, NULL));
					_r_ctrl_checkbutton (hwnd, IDC_INSTALLBOOTTIMEFILTERS_CHK, _r_config_getboolean_ex (L"InstallBoottimeFilters", TRUE, NULL));
					_r_ctrl_checkbutton (hwnd, IDC_USECERTIFICATES_CHK, _r_config_getboolean_ex (L"IsCertificatesEnabled", TRUE, NULL));
					_r_ctrl_checkbutton (hwnd, IDC_USEHASHES_CHK, _r_config_getboolean_ex (L"IsHashesEnabled", FALSE, NULL));
					_r_ctrl_checkbutton (hwnd, IDC_USENETWORKRESOLUTION_CHK, _r_config_getboolean_ex (L"IsNetworkResolutionsEnabled", FALSE, NULL));
				...
				case IDD_SETTINGS_BLOCKLIST:
				{
					_r_ctrl_checkradio (
						hwnd,
						IDC_BLOCKLIST_SPY_DISABLE, IDC_BLOCKLIST_SPY_BLOCK, IDC_BLOCKLIST_SPY_DISABLE + _r_calc_clamp (_r_config_getlong_ex (L"BlocklistSpyState", 2, NULL), 0, 2)
					);

					_r_ctrl_checkradio (
						hwnd,
						IDC_BLOCKLIST_UPDATE_DISABLE, IDC_BLOCKLIST_UPDATE_BLOCK, IDC_BLOCKLIST_UPDATE_DISABLE + _r_calc_clamp (_r_config_getlong_ex (L"BlocklistUpdateState", 0, NULL), 0, 2)
					);

					_r_ctrl_checkradio (
						hwnd,
						IDC_BLOCKLIST_EXTRA_DISABLE, IDC_BLOCKLIST_EXTRA_BLOCK, IDC_BLOCKLIST_EXTRA_DISABLE + _r_calc_clamp (_r_config_getlong_ex (L"BlocklistExtraState", 0, NULL), 0, 2)
					);
				...
				{
					_r_ctrl_checkbutton (hwnd, IDC_CONFIRMEXIT_CHK, _r_config_getboolean_ex (L"ConfirmExit2", TRUE, NULL));
					_r_ctrl_checkbutton (hwnd, IDC_CONFIRMEXITTIMER_CHK, _r_config_getboolean_ex (L"ConfirmExitTimer", TRUE, NULL));
					_r_ctrl_checkbutton (hwnd, IDC_CONFIRMLOGCLEAR_CHK, _r_config_getboolean_ex (L"ConfirmLogClear", TRUE, NULL));
					_r_ctrl_checkbutton (hwnd, IDC_CONFIRMALLOW_CHK, _r_config_getboolean_ex (L"ConfirmAllow", TRUE, NULL));
					_r_ctrl_checkbutton (hwnd, IDC_TRAYICONSINGLECLICK_CHK, _r_config_getboolean_ex (L"IsTrayIconSingleClick", TRUE, NULL));
				...
				{
					_r_ctrl_checkbutton (hwnd, IDC_ENABLENOTIFICATIONS_CHK, _r_config_getboolean_ex (L"IsNotificationsEnabled", TRUE, NULL));
					_r_ctrl_checkbutton (hwnd, IDC_NOTIFICATIONSOUND_CHK, _r_config_getboolean_ex (L"IsNotificationsSound", TRUE, NULL));
					_r_ctrl_checkbutton (hwnd, IDC_NOTIFICATIONFULLSCREENSILENTMODE_CHK, _r_config_getboolean_ex (L"IsNotificationsFullscreenSilentMode", TRUE, NULL));
					_r_ctrl_checkbutton (hwnd, IDC_NOTIFICATIONONTRAY_CHK, _r_config_getboolean_ex (L"IsNotificationsOnTray", FALSE, NULL));

					_r_updown_setrange (hwnd, IDC_NOTIFICATIONTIMEOUT, 0, _r_calc_days2seconds (7));

					_r_updown_setvalue (hwnd, IDC_NOTIFICATIONTIMEOUT, _r_config_getulong_ex (L"NotificationsTimeout", NOTIFY_TIMEOUT_DEFAULT, NULL));
				...
				case IDD_SETTINGS_LOGGING:
				{
					...
					_r_ctrl_checkbutton (hwnd, IDC_ENABLELOG_CHK, _r_config_getboolean_ex (L"IsLogEnabled", FALSE, NULL));
					...
					_r_updown_setvalue (hwnd, IDC_LOGSIZELIMIT, _r_config_getulong_ex (L"LogSizeLimitKb", LOG_SIZE_LIMIT_DEFAULT, NULL));

					_r_ctrl_checkbutton (hwnd, IDC_ENABLEUILOG_CHK, _r_config_getboolean_ex (L"IsLogUiEnabled", FALSE, NULL));
				...
				{
					_r_ctrl_checkbutton (hwnd, IDC_EXCLUDEBLOCKLIST_CHK, _r_config_getboolean_ex (L"IsExcludeBlocklist", TRUE, NULL));
					_r_ctrl_checkbutton (hwnd, IDC_EXCLUDECUSTOM_CHK, _r_config_getboolean_ex (L"IsExcludeCustomRules", TRUE, NULL));
					_r_ctrl_checkbutton (hwnd, IDC_EXCLUDESTEALTH_CHK, _r_config_getboolean_ex (L"IsExcludeStealth", TRUE, NULL));
					_r_ctrl_checkbutton (hwnd, IDC_EXCLUDECLASSIFYALLOW_CHK, _r_config_getboolean_ex (L"IsExcludeClassifyAllow", TRUE, NULL));
		...
		case WM_HSCROLL:
		{
			...
			if (ctrl_id == IDC_LOGSIZELIMIT)
			{
				...
				_r_config_setlong_ex (L"LogSizeLimitKb", value, NULL);
			}
			else if (ctrl_id == IDC_NOTIFICATIONTIMEOUT)
			{
				value = _r_updown_getvalue (hwnd, ctrl_id);

				_r_config_setlong_ex (L"NotificationsTimeout", value, NULL);
			}
		...
		case WM_COMMAND:
		{
			...
			switch (ctrl_id)
			{
				case IDC_ALWAYSONTOP_CHK:
				{
					...
					_r_config_setboolean_ex (L"AlwaysOnTop", is_enabled, NULL);
				...
				{
					_r_config_setboolean_ex (L"ConfirmExit2", _r_ctrl_isbuttonchecked (hwnd, ctrl_id), NULL);
					break;
				}

				case IDC_CONFIRMEXITTIMER_CHK:
				{
					_r_config_setboolean_ex (L"ConfirmExitTimer", _r_ctrl_isbuttonchecked (hwnd, ctrl_id), NULL);
					break;
				}

				case IDC_CONFIRMLOGCLEAR_CHK:
				{
					_r_config_setboolean_ex (L"ConfirmLogClear", _r_ctrl_isbuttonchecked (hwnd, ctrl_id), NULL);
					break;
				}

				case IDC_CONFIRMALLOW_CHK:
				{
					_r_config_setboolean_ex (L"ConfirmAllow", _r_ctrl_isbuttonchecked (hwnd, ctrl_id), NULL);
					break;
				}

				case IDC_TRAYICONSINGLECLICK_CHK:
				{
					_r_config_setboolean_ex (L"IsTrayIconSingleClick", _r_ctrl_isbuttonchecked (hwnd, ctrl_id), NULL);
					break;
				}
				...
				case IDC_BLOCKLIST_EXTRA_BLOCK:
				{
					...
					if (ctrl_id >= IDC_BLOCKLIST_SPY_DISABLE && ctrl_id <= IDC_BLOCKLIST_SPY_BLOCK)
					{
						...
						_r_config_setlong_ex (L"BlocklistSpyState", new_state, NULL);
					...
					else if (ctrl_id >= IDC_BLOCKLIST_UPDATE_DISABLE && ctrl_id <= IDC_BLOCKLIST_UPDATE_BLOCK)
					{
						...
						_r_config_setlong_ex (L"BlocklistUpdateState", new_state, NULL);
					...
					else if (ctrl_id >= IDC_BLOCKLIST_EXTRA_DISABLE && ctrl_id <= IDC_BLOCKLIST_EXTRA_BLOCK)
					{
						...
						_r_config_setlong_ex (L"BlocklistExtraState", new_state, NULL);
				...
				case IDC_ENABLELOG_CHK:
				{
					...
					if (!is_postmessage)
					{
						_r_config_setboolean_ex (L"IsLogEnabled", is_enabled, NULL);
				...
				case IDC_ENABLEUILOG_CHK:
				{
					...
					_r_config_setboolean_ex (L"IsLogUiEnabled", is_enabled, NULL);
				...
				case IDC_LOGPATH:
				{
					...
					if (notify_code == EN_KILLFOCUS)
					{
						...
						if (log_path)
						{
							_r_config_setstringexpand_ex (L"LogPath", log_path->buffer, NULL);
				...
				case IDC_LOGPATH_BTN:
				{
					...
					if (SUCCEEDED (status))
					{
						...
						if (SUCCEEDED (status))
						{
							...
							if (SUCCEEDED (status))
							{
								_r_config_setstringexpand_ex (L"LogPath", path->buffer, NULL);
								_r_ctrl_setstring (hwnd, IDC_LOGPATH, path->buffer);

								_app_loginit (_r_config_getboolean_ex (L"IsLogEnabled", FALSE, NULL));
				...
				case IDC_LOGVIEWER:
				{
					...
					_r_config_setstringexpand_ex (L"LogViewer", log_viewer->buffer, NULL);
				...
				case IDC_LOGVIEWER_BTN:
				{
					...
					if (SUCCEEDED (status))
					{
						...
						if (SUCCEEDED (status))
						{
							...
							if (SUCCEEDED (status))
							{
								_r_config_setstringexpand_ex (L"LogViewer", path->buffer, NULL);
								_r_ctrl_setstring (hwnd, IDC_LOGVIEWER, path->buffer);
				...
				case IDC_ENABLENOTIFICATIONS_CHK:
				{
					...
					if (!is_postmessage)
						_r_config_setboolean_ex (L"IsNotificationsEnabled", is_enabled, NULL);
				...
				case IDC_NOTIFICATIONSOUND_CHK:
				{
					...
					if (!is_postmessage)
						_r_config_setboolean_ex (L"IsNotificationsSound", is_checked, NULL);
				...
				{
					_r_config_setboolean_ex (L"IsNotificationsFullscreenSilentMode", _r_ctrl_isbuttonchecked (hwnd, ctrl_id), NULL);
					break;
				}
				...
				case IDC_NOTIFICATIONONTRAY_CHK:
				{
					...
					_r_config_setboolean_ex (L"IsNotificationsOnTray", _r_ctrl_isbuttonchecked (hwnd, ctrl_id), NULL);
				...
				{
					if (notify_code == EN_KILLFOCUS)
						_r_config_setlong_ex (L"NotificationsTimeout", _r_updown_getvalue (hwnd, IDC_NOTIFICATIONTIMEOUT), NULL);
				...
				{
					_r_config_setboolean_ex (L"IsExcludeStealth", _r_ctrl_isbuttonchecked (hwnd, ctrl_id), NULL);
					break;
				}
				...
				case IDC_EXCLUDECLASSIFYALLOW_CHK:
				{
					...
					_r_config_setboolean_ex (L"IsExcludeClassifyAllow", _r_ctrl_isbuttonchecked (hwnd, ctrl_id), NULL);
				...
				{
					_r_config_setboolean_ex (L"IsExcludeBlocklist", _r_ctrl_isbuttonchecked (hwnd, ctrl_id), NULL);
					break;
				}

				case IDC_EXCLUDECUSTOM_CHK:
				{
					_r_config_setboolean_ex (L"IsExcludeCustomRules", _r_ctrl_isbuttonchecked (hwnd, ctrl_id), NULL);
					break;
				}
			}
...
)
{
	switch (msg)
	{
		case WM_INITDIALOG:
		{
			...
			// initialize tab
			_app_settab_id (hwnd, _r_config_getlong_ex (L"CurrentTab", IDC_APPS_PROFILE, NULL));
		...
		case RM_TRAYICON:
		{
			switch (LOWORD (lparam))
			{
				...
				case WM_LBUTTONUP:
				{
					if (_r_config_getboolean_ex (L"IsTrayIconSingleClick", TRUE, NULL))
					{
		...
		case WM_NOTIFY:
		{
			...
			switch (nmlp->code)
			{
				...
				case TCN_SELCHANGE:
				{
					...
					_r_config_setlong_ex (L"CurrentTab", listview_id, NULL);
		...
		case WM_COMMAND:
		{
			...
			switch (ctrl_id)
			{
				...
				case IDM_ALWAYSONTOP_CHK:
				{
					...
					new_val = !_r_config_getboolean_ex (L"AlwaysOnTop", FALSE, NULL);

					_r_menu_checkitem (GetMenu (hwnd), ctrl_id, 0, MF_BYCOMMAND, new_val);
					_r_config_setboolean_ex (L"AlwaysOnTop", new_val, NULL);
				...
				case IDM_AUTOSIZECOLUMNS_CHK:
				{
					...
					new_val = !_r_config_getboolean_ex (L"AutoSizeColumns", TRUE, NULL);

					_r_menu_checkitem (GetMenu (hwnd), ctrl_id, 0, MF_BYCOMMAND, new_val);
					_r_config_setboolean_ex (L"AutoSizeColumns", new_val, NULL);
				...
				case IDM_SHOWFILENAMESONLY_CHK:
				{
					...
					new_val = !_r_config_getboolean_ex (L"ShowFilenames", TRUE, NULL);

					_r_menu_checkitem (GetMenu (hwnd), ctrl_id, 0, MF_BYCOMMAND, new_val);
					_r_config_setboolean_ex (L"ShowFilenames", new_val, NULL);
				...
				case IDM_SHOWSEARCHBAR_CHK:
				{
					...
					new_val = !_r_config_getboolean_ex (L"IsShowSearchBar", TRUE, NULL);

					_r_menu_checkitem (GetMenu (hwnd), ctrl_id, 0, MF_BYCOMMAND, new_val);

					_r_config_setboolean_ex (L"IsShowSearchBar", new_val, NULL);
				...
				case IDM_VIEW_TILE:
				{
					...
					_r_config_setlong_ex (L"ViewType", view_type, NULL);
				...
				case IDM_SIZE_EXTRALARGE:
				{
					...
					_r_config_setlong_ex (L"IconSize", icon_size, NULL);
				...
				case IDM_ICONSISHIDDEN:
				{
					...
					new_val = !_r_config_getboolean_ex (L"IsIconsHidden", FALSE, NULL);

					_r_menu_checkitem (GetMenu (hwnd), ctrl_id, 0, MF_BYCOMMAND, new_val);
					_r_config_setboolean_ex (L"IsIconsHidden", new_val, NULL);
				...
				case IDM_TRAY_ENABLELOG_CHK:
				{
					...
					new_val = !_r_config_getboolean_ex (L"IsLogEnabled", FALSE, NULL);
					...
					_r_config_setboolean_ex (L"IsLogEnabled", new_val, NULL);
				...
				case IDM_TRAY_ENABLEUILOG_CHK:
				{
					...
					new_val = !_r_config_getboolean_ex (L"IsLogUiEnabled", FALSE, NULL);

					_r_toolbar_setbutton (config.hrebar, IDC_TOOLBAR, ctrl_id, NULL, 0, new_val ? TBSTATE_PRESSED | TBSTATE_ENABLED : TBSTATE_ENABLED, I_IMAGENONE);

					_r_config_setboolean_ex (L"IsLogUiEnabled", new_val, NULL);
				...
				case IDM_TRAY_ENABLENOTIFICATIONS_CHK:
				{
					...
					new_val = !_r_config_getboolean_ex (L"IsNotificationsEnabled", TRUE, NULL);

					_r_toolbar_setbutton (config.hrebar, IDC_TOOLBAR, ctrl_id, NULL, 0, new_val ? TBSTATE_PRESSED | TBSTATE_ENABLED : TBSTATE_ENABLED, I_IMAGENONE);

					_r_config_setboolean_ex (L"IsNotificationsEnabled", new_val, NULL);
				...
				case IDM_TRAY_ENABLENOTIFICATIONSSOUND_CHK:
				{
					...
					new_val = !_r_config_getboolean_ex (L"IsNotificationsSound", TRUE, NULL);

					_r_config_setboolean_ex (L"IsNotificationsSound", new_val, NULL);
				...
				case IDM_TRAY_NOTIFICATIONFULLSCREENSILENTMODE_CHK:
				{
					...
					new_val = !_r_config_getboolean_ex (L"IsNotificationsFullscreenSilentMode", TRUE, NULL);

					_r_config_setboolean_ex (L"IsNotificationsFullscreenSilentMode", new_val, NULL);
				...
				case IDM_TRAY_NOTIFICATIONONTRAY_CHK:
				{
					...
					new_val = !_r_config_getboolean_ex (L"IsNotificationsOnTray", FALSE, NULL);

					_r_config_setboolean_ex (L"IsNotificationsOnTray", new_val, NULL);
